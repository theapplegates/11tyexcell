...
An image test of [Cloudinary's image service](https://cloudinary.com).
![A beautiful snowy city](https://applegate-paul.mo.cloudinary.net/zoom/Vitebsk-Belarus.jpg)
Photo by [Artem Balashevsky](https://unsplash.com/@abalashevsky?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash) on [Unsplash](https://unsplash.com/photos/a-snowy-night-in-a-big-city-with-a-lot-of-lights-c6SKh5oPavc?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash)
...
{% imagePlaceholder "./src/assets/images/stairs.jpg", "The preview for social media", "" %}
